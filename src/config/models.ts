import { ProviderType, ModelDefinition } from '../types';
...
export interface ProviderDefinition {
    id: ProviderType;               // Type identifier (for SDK selection)
 ...
 */
export function getProviderById(id: ProviderType): ProviderDefinition | undefined {
